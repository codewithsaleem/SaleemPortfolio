                ...
                <div>
                    ...
                    <div className='mb-[3rem] flex items-center md:space-x-10'>
                        ...
                        <p className='text-[19px] text-slate-300 w-[80%]'>
                            I am a highly skilled Full Stack developer with 1 years of experience in HTML, CSS, JavaScript and MERN.
                            Working as React Developer and currently handling CRMs, Admin Panels and websites.
                            Developing APIs, robust databases on MongoDB, creating Restfull APIs on POSTMAN/APIDOG.
                        </p>
                    </div>
